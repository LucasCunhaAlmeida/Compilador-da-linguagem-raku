...
def p_prefixo_incremento(p):
   ...
   p[0] = sa.Expressao_PREFIXO_INCREMENTO(p[2]) 
...
def p_prefixo_decremento(p):
   ...
   p[0] = sa.Expressao_PREFIXO_DECREMENTO(p[2]) 
...
def p_declaracao_escalar_MY(p):
  '''declaracao_escalar_MY : MY tipo_opicional ESCALAR IGUAL exp_2 PONTO_VIRGULA''' 
  pass

def p_declaracao_escalar_OUR(p):
  '''declaracao_escalar_OUR : OUR tipo_opicional ESCALAR IGUAL exp_2 PONTO_VIRGULA''' 
  pass
...
# --- ESTRUTURA DE BLOCOS E DECLARAÇÕES---------------
